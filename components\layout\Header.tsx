        ...
        <div className="flex items-center gap-3 sm:gap-4 text-xs font-mono ml-auto">
          ...
          {setAutoRefreshInterval && (
            <div className="hidden sm:flex items-center gap-2 bg-[var(--mw-card)] border border-[var(--mw-border)] rounded-md px-2 py-1 shadow-sm">
               ...
               <select 
                 className="bg-transparent text-[var(--mw-text-main)] outline-none text-xs cursor-pointer"
          ...
          <div className="hidden lg:flex items-center gap-2 px-3 py-1.5 bg-[var(--mw-green)]/10 border border-[var(--mw-green)]/20 rounded text-[var(--mw-green)] font-bold uppercase tracking-wider text-[10px]">
             ...
             user ? (
               <div className="flex items-center gap-3">
                  <div className="flex flex-col items-end">
                    ...
                    {profile && (
                       <span className="text-[var(--mw-gold-bright)] text-[10px]">
