...
const GATHER_BASE: Record<number, number> = { 4: 48, 5: 32, 6: 32, 7: 38.4, 8: 38.4 };
        ...
        <div className="md:col-span-2 bg-[#151518] rounded-xl border border-white/5 p-6 shadow-xl relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row gap-6 relative">
            <div className="flex-1 space-y-2">
              ...
              <p className="text-[10px] text-white/30 leading-relaxed max-w-sm">Nota: Valores de retorno são estimativas baseadas em dados da comunidade. O retorno real depende do tier do diário vs tier do trabalhador. Usar diário 1 tier abaixo pode resultar em até 150% de retorno.</p>
            </div>
             ...
             <div className="bg-black/30 border border-white/5 rounded-lg overflow-hidden flex flex-col hover:border-white/10 transition-colors">
                <div className="flex items-center gap-3 p-4 border-b border-white/5 bg-black/40">
                   ...
                   <div>
                     ...
                     <p className="text-[10px] text-[var(--mw-text-muted)] uppercase tracking-widest">Prata Fixa (acima de 100%: chance de duplicar)</p>
                   </div>
                </div>
                <div className="grid grid-cols-5 text-center divide-x divide-white/5">
                  {TIERS.map(t => {
