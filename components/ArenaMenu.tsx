...
import { Swords, TentTree, Settings, LogOut, Flame } from 'lucide-react';
...
interface ArenaMenuProps {
  onSelectModule: (module: 'operations' | 'island' | 'settings' | 'refining') => void;
}
      ...
      <div className="z-10 w-full max-w-6xl px-4 flex flex-col items-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--mw-gold-primary)]/10 border border-[var(--mw-gold-primary)]/20 mb-6 animate-fade-up">
            ...
            <span className="text-sm font-bold uppercase tracking-widest text-[var(--mw-gold-bright)]">v2.1 — Motor de Scoring Atualizado</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl mx-auto">
          ...
          <motion.button
            ...
            className="relative group overflow-hidden rounded-2xl border border-[var(--mw-border)] bg-[var(--mw-card)]/80 backdrop-blur-sm p-8 text-left transition-all hover:border-[var(--mw-gold-primary)] hover:shadow-[0_0_40px_-10px_rgba(201,168,76,0.3)] aspect-[4/3] flex flex-col justify-end"
          >
            ...
            <div className="relative z-20">
              ...
              <h2 className="text-xl font-black uppercase tracking-wider text-[var(--mw-text-main)] mb-2">
          ...
          <motion.button
            ...
            className="relative group overflow-hidden rounded-2xl border border-emerald-900/50 bg-[var(--mw-card)]/80 backdrop-blur-sm p-8 text-left transition-all hover:border-emerald-500 hover:shadow-[0_0_40px_-10px_rgba(16,185,129,0.3)] aspect-[4/3] flex flex-col justify-end"
          >
            <div className="absolute inset-0 bg-gradient-to-t from-[var(--mw-card)] via-[var(--mw-card)]/80 to-transparent z-10" />
            ...
            <div className="relative z-20">
              ...
              <div className="flex items-center gap-3 mb-2">
                <h2 className="text-xl font-black uppercase tracking-wider text-[var(--mw-text-main)]">
                  A Ilha
                </h2>
              </div>
              <p className="text-[var(--mw-text-muted)] text-sm">
          ...
          <motion.button
            whileHover={{ scale: 1.02, y: -5 }}
            whileTap={{ scale: 0.98 }}
            onClick={() => onSelectModule('refining')}
            className="relative group overflow-hidden rounded-2xl border border-orange-900/50 bg-[var(--mw-card)]/80 backdrop-blur-sm p-8 text-left transition-all hover:border-orange-500 hover:shadow-[0_0_40px_-10px_rgba(249,115,22,0.3)] aspect-[4/3] flex flex-col justify-end"
          >
            <div className="absolute inset-0 bg-gradient-to-t from-[var(--mw-card)] via-[var(--mw-card)]/80 to-transparent z-10" />

            <div className="absolute top-0 right-0 w-64 h-64 bg-orange-900/20 rounded-full blur-3xl group-hover:bg-orange-600/20 transition-colors" />
            ...
            <div className="relative z-20">
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="px-2 py-0.5 rounded text-sm font-black uppercase tracking-widest bg-orange-500/20 text-orange-400 border border-orange-500/30">
                  Novo
                </span>
              </div>
              <p className="text-[var(--mw-text-muted)] text-sm">
                Guia completo e calculadoras de refino e focus.
              </p>
            </div>
          </motion.button>
        </div>
