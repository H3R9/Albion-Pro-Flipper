              ...
              <div className="bg-sky-500/10 border border-sky-500/30 rounded-lg p-4 text-sm text-[var(--mw-text-main)]">
                ...
                <ul className="list-disc pl-5 mt-3 space-y-1 text-xs text-[var(--mw-text-muted)]">
                  ...
                  {!laborer.hasSpecificTrophy && laborer.category === 'CRAFTING' && (
                    <li className="text-amber-400"><strong>Atenção:</strong> Artesões NÃO possuem troféus específicos. A felicidade total deles não atinge 100/100 naturalmente apenas com troféus gerais, a não ser com ajuda do troféu do Tubarão (T7) ou troféus de guilda.</li>
                  )}
                  {laborer.id === 'FISHING' && (
                    <li className="text-sky-300"><strong>Tubarão:</strong> O Troféu de Tubarão é T7, logo só pode ser colocado em casas T7 ou T8, e fornece bônus de felicidade extra para Pescadores!</li>
                  )}
                </ul>
                <div className="mt-3 p-3 bg-black/20 rounded border border-white/5 text-xs">
                  <strong className="text-white">Respondendo à sua dúvida (Exemplo na Casa T6):</strong><br />
                  Se você colocou os Troféus Gerais (T2 ao T6 = +25 de feli.) e TODOS os Troféus do Pescador (T2 ao T6 = +50 de feli.), <strong>você recebe EXATAMENTE 75/100 de felicidade nos troféus!</strong> O resultado de 675/700 na sua print está perfeitamente correto.<br />
                  <span className="text-rose-300 block mt-1">
                    *Para passar de 75/100 para 100/100 e extrair 150% do Pescador Mestre (T6), você OBRIGATORIAMENTE precisa fazer upgrade da casa para T7 ou T8, para assim poder colocar no chão o Troféu Geral T7, Troféu do Pescador T7, e o Troféu do Tubarão T7! Uma casa T6 bloqueia troféus acima do T6.
                  </span>
                </div>
              </div>
