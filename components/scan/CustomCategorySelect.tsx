    ...
    <div className={cn("relative", className)} ref={containerRef}>
      ...
      {isOpen && !disabled && (
        <div className="absolute top-full left-0 mt-1 w-64 max-h-80 overflow-y-auto bg-[var(--mw-card)] border border-[var(--mw-border)] rounded shadow-xl z-50 p-1 flex flex-col gap-1 origin-top scrollbar-hide">
          ...
          <div className="px-3 py-1 text-sm font-black uppercase text-[var(--mw-text-muted)] mt-1">Categorias Principais</div>
          ...
          <div className="px-3 py-1 text-sm font-black uppercase text-[var(--mw-text-muted)] mt-1">Subcategorias</div>
