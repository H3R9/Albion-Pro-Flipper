             ...
             reports.map(report => (
               <div key={report.id} className="relative group">
                 ...
                 <button
                   ...
                   className={`absolute top-3 right-3 transition-opacity p-1 rounded ${confirmDeleteId === report.id ? 'opacity-100 text-white bg-red-600 hover:bg-red-700 font-bold text-sm px-2 py-1' : 'opacity-0 group-hover:opacity-100 text-slate-400 hover:text-red-400'}`}
