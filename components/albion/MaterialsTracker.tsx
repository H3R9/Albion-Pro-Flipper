    ...
    <div className="bg-[var(--mw-card)]/80 border border-[var(--mw-border)] rounded-xl p-6 shadow-lg w-full">
      ...
      <div className="bg-[var(--mw-bg)]/60 border border-[var(--mw-border)] rounded-xl p-4 mb-8 flex gap-4 items-start shadow-sm">
        ...
        <div className="flex-1">
          ...
          <p className="text-[var(--mw-text-muted)] text-sm leading-relaxed max-w-4xl">
              ...
              <div key={tier} className="bg-[var(--mw-bg)] border border-[var(--mw-border)] rounded-xl overflow-hidden shadow-sm mb-6">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-sm whitespace-nowrap">
                    <thead className="bg-[#0b0c10]/40 text-[var(--mw-text-muted)] border-b border-[var(--mw-border)] font-bold text-sm uppercase tracking-widest">
                      <tr>
                          ...
                          <tr key={item.itemId} className="hover:bg-[var(--mw-card-hover)] transition-colors">
                            ...
                            <td className="p-4 text-right">
                              {hasOrder ? (
                                <div className="flex flex-col items-end gap-1.5">
                                  <div className="flex items-center gap-2 text-[var(--mw-text-main)] font-mono text-sm bg-[var(--mw-card)] px-2 py-0.5 rounded border border-[var(--mw-border)] shadow-sm">
                                    <span className="text-blue-400 text-sm font-sans tracking-widest uppercase">PEDIDO ({item.bestOrderCity})</span>
                              ...
                              {hasDirect ? (
                                <div className="flex flex-col items-end gap-1.5 mt-1">
                                  <div className="flex items-center gap-2 text-[var(--mw-text-main)] font-mono text-sm bg-[var(--mw-card)] px-2 py-0.5 rounded border border-[var(--mw-border)] shadow-sm">
                                    <span className="text-[var(--mw-gold-bright)] text-sm font-sans tracking-widest uppercase">DIRETA ({item.bestDirectCity})</span>
                                    <span className="font-black text-[var(--mw-gold-bright)]">{formatSilver(item.bestDirectPrice)}</span>
                                  </div>
                                </div>
                              ) : null}
                              {!hasDirect && !hasOrder && <span className="text-[var(--mw-text-muted)] text-sm uppercase font-bold tracking-widest">Indisponível</span>}
                            </td>
                            ...
                            <td className="p-4 text-right">
                              {item.caerleonSellPrice && item.caerleonSellPrice < Infinity ? (
                                <div className="flex flex-col items-end gap-1.5">
                                  <div className="flex items-center gap-2 text-[var(--mw-text-main)] font-mono text-sm bg-[var(--mw-card)] px-2 py-0.5 rounded border border-[var(--mw-border)] shadow-sm">
                                    <span className="text-[var(--mw-green)] text-sm font-sans tracking-widest uppercase">VENDA DIRETA</span>
                              ...
                              {item.caerleonBuyOrder && item.caerleonBuyOrder > 0 ? (
                                <div className="flex flex-col items-end gap-1.5 mt-1">
                                  <div className="flex items-center gap-2 text-[var(--mw-text-main)] font-mono text-sm bg-[var(--mw-card)] px-2 py-0.5 rounded border border-[var(--mw-border)] shadow-sm">
                                    <span className="text-blue-400 text-sm font-sans tracking-widest uppercase">PARA PEDIDO BM</span>
                              ...
                              {(!item.caerleonSellPrice || item.caerleonSellPrice === Infinity) && (!item.caerleonBuyOrder || item.caerleonBuyOrder === 0) && (
                                <span className="text-[var(--mw-text-muted)] text-sm uppercase font-bold tracking-widest">Indisponível</span>
                              )}
                            </td>
                              ...
                              {(() => {
                                ...
                                return (
                                  <div className="flex flex-col items-center">
                                    ...
                                    <span className="text-sm text-[var(--mw-text-muted)] mt-0.5 font-mono">{margin.toFixed(1)}%</span>
                                  </div>
                                );
                              })()}
                            </td>
                            ...
                            <td className="p-4 text-center">
                              {!item.trend ? (
                                ...
                                <div className={cn(
                                  "flex items-center justify-center gap-1 font-bold text-sm px-2 py-1 rounded w-max mx-auto shadow-sm tracking-wide",
