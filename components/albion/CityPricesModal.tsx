      ...
      {itemId && (
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between p-4 border-b border-[var(--mw-border)] bg-[var(--mw-bg)]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--mw-text-muted)] font-mono uppercase">
                    {itemId}
                  </p>
                </div>
              </div>
            ...
            <div className="p-0 overflow-y-auto w-full relative">
              ...
              <table className="w-full text-left border-collapse text-sm min-w-[500px]">
                <thead className="bg-[var(--mw-bg)] sticky top-0 z-10 border-b border-[var(--mw-border)]">
                  <tr>
                    <th className="py-3 px-4 font-bold text-sm uppercase tracking-widest text-[var(--mw-text-muted)]">Cidade</th>
                    <th className="py-3 px-4 font-bold text-sm uppercase tracking-widest text-[var(--mw-text-muted)]">Venda Direta (Sell)</th>
                    <th className="py-3 px-4 font-bold text-sm uppercase tracking-widest text-[var(--mw-text-muted)]">Pedido de Compra (Buy)</th>
                  </tr>
                </thead>
                  ...
                  {sortedSell.map((row, i) => (
                    <tr key={row.city} className="hover:bg-[var(--mw-bg)]/50 transition-colors">
                      <td className="py-3 px-4 font-bold text-[var(--mw-text-main)] flex items-center gap-2">
                        <span className="w-5 h-5 rounded-full bg-[var(--mw-bg)] border border-[var(--mw-border)] flex items-center justify-center text-sm text-[var(--mw-text-muted)]">
                          {i + 1}
                        </span>
                        {row.city}
                      </td>
                      <td className="py-3 px-4">
                        <div className="flex flex-col">
                          ...
                          <span className="text-sm text-[var(--mw-text-muted)]">
            ...
            {/* Footer */}
            <div className="p-4 border-t border-[var(--mw-border)] bg-[var(--mw-bg)] text-sm text-center text-[var(--mw-text-muted)] uppercase tracking-widest font-bold">
