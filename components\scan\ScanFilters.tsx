  ...
  return (
    <div className="flex justify-between items-end mb-4 border-b border-[var(--mw-border)] pb-4">
      <div className="relative">
        <label className="text-[10px] font-bold text-[var(--mw-text-muted)] uppercase tracking-widest mb-1.5 block">Filtro Rápido</label>
        <div className="relative">
      ...
      <div className="flex flex-col items-end gap-1">
        ...
        <span className="text-[10px] text-[var(--mw-text-muted)] uppercase tracking-widest">Base de Dados: {totalItemsInDb}</span>
      </div>
    </div>
  );
}
