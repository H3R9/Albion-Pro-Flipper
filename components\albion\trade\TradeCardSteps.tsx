...
function StepItem({ stepNum, color, title, children }: { stepNum: number; color: string; title: string; children: React.ReactNode }) {
  return (
    <div className="relative flex items-start gap-4">
      <div className={`absolute left-[-28px] ${color} text-white w-6 h-6 rounded-full flex items-center justify-center font-bold text-xs ring-4 ring-slate-900`}>{stepNum}</div>
